...
class SawyerButtonPressWallEnvV2(SawyerXYZEnv):
    ...
    def compute_reward(self, action, obs):
        ...
        # print('button_pressed', button_pressed, 'obj_to_target', obj_to_target, 'self._obj_to_target_init', self._obj_to_target_init)
        # reward = 10 * button_pressed # modificaiton: change to only consider button_pressed reward
